...
<body style="background-color:antiquewhite;text-align: center;">
    ...
    <form action="regprofe.php" method="post">
        ...
        <p>Cédula</p>
        <input class="form-control" type="number" name="ced" id="">
        <p>Nombres</p>
        <input class="form-control" type="text" name="nom" id="">
        <p>Dirección</p>
        <input class="form-control" type="text" name="dir" id="">
        <p>Número Celular</p>
        <input class="form-control" type="number" name="cel" id="">
